...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-24 14:34`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/434a0444-1480-4ee1-b033-2e86d1faec20.git
$ cd 434a0444-1480-4ee1-b033-2e86d1faec20
```
